...
public:
    ...
    static ByteConfigItem& getBacklightGreen() { static ByteConfigItem backlight_green("backlight_green", 3); return backlight_green; }
    static ByteConfigItem& getBacklightBlue() { static ByteConfigItem backlight_blue("backlight_blue", 0); return backlight_blue; }

    static BooleanConfigItem& getUnderlights() { static BooleanConfigItem underlights("underlights", false); return underlights; }
    static ByteConfigItem& getUnderlightRed() { static ByteConfigItem underlight_red("underlight_red", 0); return underlight_red; }
